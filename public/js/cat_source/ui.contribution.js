  ...
  renderContributions: function(d, segment) {
    ...
    if ( d.data.hasOwnProperty('matches') && d.data.matches.length) {
      ...
      if((config.mt_enabled)&&(!config.id_translator)) {
                $('.sub-editor.matches .overflow', segment).append('<ul class="graysmall message"><li>No matches could be found for this segment. Please, contact <a href="mailto:support@atman360.com">support@atman360.com</a> if you think this is an error.</li></ul>');
            } else {
